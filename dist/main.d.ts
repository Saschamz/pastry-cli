...
}, variantsToRemove: any): Promise<void | [unknown, unknown, unknown, unknown, unknown, unknown, unknown, unknown, unknown, unknown]>;
...
export declare function findAndReplace(path: string, replacement: string, variantsToRemove: string[]): Promise<void>;
