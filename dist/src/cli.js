...
import { copyTemplateToFinalpath, copyTemplateToTemporaryPath, createOrRemoveTempDir, getTemplates, getVariantsToRemove, removePath, renameFiles, } from './main';
...
export async function cli(rawArgs) {
    ...
    if (!options.template_rename)
        prompts.push(questions.template_rename);
    if (!options.copy_path_affix)
        prompts.push(questions.copy_path_affix);
...
export async function createFlow(answers) {
    try {
...
export async function renameFlow(answers) {
